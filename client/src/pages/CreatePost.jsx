...
const CreatePost = () => {
  ...
  const [generatingImg, setGneratingImg] = useState(false)
  ...
  const handleSubmit=async(e)=>{
    ...
    }else alert("please enter a prompt and generate an iamge")
  }

  const generateImage=async()=>{
    if(form.prompt){
      try {
        setGneratingImg(true)
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className=" flex flex-col gap-5">
          ...
          <FormField labelName="Prompt" type="text" name="prompt" placeholder="panda mad scientist mixing sparkling chemicals, digital art" value={form.prompt} handleChange={handleChange} isSupriseMe handleSupriseMe={handleSupriseMe}/>
